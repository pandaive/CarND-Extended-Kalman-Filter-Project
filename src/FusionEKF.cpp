...
FusionEKF::FusionEKF() {
  ...
  // initialized measurement matrix
  H_laser_ << 1, 0, 0, 0,
              0, 1, 0, 0;
  ...
  //initialized state covariance matrix
  ...
  //set accelaration noise components
  noise_ax = 9;// provided in quiz as 9 in 5.13
  noise_ay = 9;// provided in quiz as 9 in 5.13
